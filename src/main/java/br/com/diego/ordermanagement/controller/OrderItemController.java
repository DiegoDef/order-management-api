...
public class OrderItemController {
    ...
    @PostMapping
    public ResponseEntity<EntityIdDTO> create(@Valid @RequestBody OrderItemDTO dto) {
    ...
    @PutMapping
    public ResponseEntity<EntityIdDTO> update(@Valid @RequestBody OrderItemDTO dto) {
